...
exports.healthCheck = exports.dailySyncUsersPhotoURL = exports.syncAllUsersPhotoURL = exports.cleanupDeletedAccounts = exports.onMemberRemoved = exports.onMemberAdded = exports.onExpenseDeleted = exports.onExpenseUpdated = exports.onExpenseCreated = void 0;
...
exports.onExpenseCreated = functions.firestore
    ...
    try {
        ...
        // 為每個成員建立通知
        const notificationPromises = members.map(member => db.collection('notifications').add({
 ...
 * 刪除支出時建立通知
 */
exports.onExpenseDeleted = functions.firestore
    .document('trips/{tripId}/expenses/{expenseId}')
...
exports.onMemberRemoved = functions.firestore
    ...
    try {
        ...
        // 為其他成員建立通知
        const notificationPromises = otherMembers.map(otherMember => db.collection('notifications').add({
 ...
 * 執行時間：每天凌晨 0 點 UTC
 */
exports.cleanupDeletedAccounts = functions.pubsub
    .schedule('0 0 * * *')
    .timeZone('UTC')
    .onRun(async (context) => {
    try {
        ...
        const usersSnapshot = await db.collection('users')
            .where('deleteRequestedAt', '<=', firestore_1.Timestamp.fromDate(sevenDaysAgo))
 ...
 * 標記使用者的所有支出為已刪除
 */
async function markUserExpensesAsDeleted(userId) {
    try {
        // 查詢所有包含該使用者支出的旅程
 ...
 */
exports.syncAllUsersPhotoURL = functions.https.onCall(async (data, context) => {
    // 檢查是否認證
    if (!context.auth) {
 ...
 */
exports.dailySyncUsersPhotoURL = functions.pubsub
    .schedule('0 1 * * *')
    .timeZone('UTC')
    .onRun(async (context) => {
    try {
